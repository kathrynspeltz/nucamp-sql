...
-- A: Create a database where the employee is the primary key and then additional columns make up their expertise
-- Q: What type of relationship is this? (e.g. 1-1, 1-many, or many-to-many?)
-- A: One to many, one user may have multiple expertize fields
...
INSERT employees_categories (employee_id, category_id)
